...
import OnboardingIntentMetrics from "@/components/analytics/OnboardingIntentMetrics";
...
export default function CrmLeadsPage() {
  ...
  function handleExportCsv() {
    ...
    link.href = url;
    link.download = "selenite-care-crm-leads.csv";
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8">
        <div>
          ...
          <p className="mt-3 text-sm leading-6 text-[#884F38] dark:text-[#8A7D75]">
            Review visitor intent, lead quality, and follow-up opportunities for marketing.
          </p>
        </div>

        <OnboardingIntentMetrics />
        ...
        {!isLoading && !error ? (
          <>
            <div className="rounded-lg border border-[#EADDCD] bg-white p-4 dark:border-[#3D3530] dark:bg-[#242220]">
              <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_220px_auto] lg:items-end">
                <div>
                  <label
                    htmlFor="crm-leads-search"
                ...
                <div>
                  <label
                    htmlFor="crm-leads-quality"
                    className="text-sm font-medium text-[#2B2B2B] dark:text-[#F0EDE8]"
                  >
                    Quality
                  </label>
                  <select
                    id="crm-leads-quality"
                    value={qualityFilter}
                    onChange={(event) =>
