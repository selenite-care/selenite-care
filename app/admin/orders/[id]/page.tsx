      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-[minmax(0,1fr)_340px]">
        ...
        <aside className="bg-card border-themed h-fit rounded-lg border p-6">
          ...
          <div className="mt-4 space-y-4 text-sm">
            ...
            <div>
              <p className="text-muted font-medium">Client</p>
              <p className="text-page mt-1">{order.user.name ?? order.user.email}</p>
              <p className="text-muted mt-1">{order.user.email}</p>
              <p className="text-muted mt-1">{order.user.phone ?? "No phone provided"}</p>
            </div>
            <div>
