...
const MEMBERSHIPS: Record<MembershipTier, MembershipTierDetails> = {
  SIGNATURE: {
    ...
    benefits: [
      ...
      "Skin Report Card",
      "Personalized Morning & Night Skincare Routine (after purchasing products from Selenite Care)",
  ...
  CRYSTAL: {
    ...
    benefits: [
      ...
      "Customized Care Plan: Personalized Product Recommendation List, Skin Report Card, Personalized Morning & Night Skincare Routine (after purchasing products from Selenite Care)",
    ],
  },
  PLATINUM: {
