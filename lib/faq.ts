...
export const FAQS: FAQItem[] = [
  ...
  { id: '2', category: 'Membership & Payments', question: 'What are Membership Programs?', answer: 'Our Membership Programs provide extended support, exclusive benefits, follow-up guidance, priority assistance, and access to additional skincare resources throughout the membership period.' },
