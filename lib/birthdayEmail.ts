export function getBirthdayEmailHtml(name: string) {
  ...
  return `
    <div style="margin:0;padding:32px 16px;background-color:#F8F5F0;font-family:Arial,sans-serif;color:#2B2B2B;">
      <div style="max-width:640px;margin:0 auto;background:#FFFFFF;border:1px solid #D8C7B5;border-radius:20px;overflow:hidden;box-shadow:0 20px 60px rgba(43,43,43,0.08);">
        <div style="padding:28px 32px;background:linear-gradient(135deg,#2B2B2B 0%,#3A332D 100%);text-align:center;">
          <div style="font-size:12px;letter-spacing:0.24em;text-transform:uppercase;color:#C6A56B;font-weight:600;">
            Selenite Care
          </div>
        ...
        <div style="padding:32px;">
          ...
          <div style="margin:24px 0;padding:22px 24px;border:1px solid #D8C7B5;border-radius:16px;background:linear-gradient(180deg,rgba(198,165,107,0.10) 0%,rgba(248,245,240,1) 100%);">
          ...
          <div style="margin-top:28px;padding-top:20px;border-top:1px solid #E9DDD0;text-align:center;">
            <p style="margin:0;font-size:14px;line-height:1.7;color:#8C7967;">
              ...
              <span style="font-family:'Playfair Display', Georgia, serif;font-size:18px;color:#C6A56B;">Selenite Care</span>
            </p>
          </div>
        </div>
      </div>
