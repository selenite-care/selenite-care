...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-[#B87B68] bg-[#2B2B2B] px-6 pb-6 pt-12 text-[#F8F5F0] dark:border-[#3D3530] dark:bg-[#141210] dark:text-[#F0EDE8]">
      ...
      <div className="relative mx-auto w-full max-w-6xl">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-3">
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <div
                style={{ background: "linear-gradient(90deg, #B87B68, transparent)" }}
                className="mt-2 h-px w-20"
              />
            </div>
            <p className="text-sm leading-6 text-[#EADDCD] dark:text-[#8A7D75]">
            ...
            <div className="flex items-center gap-3 pt-1">
              ...
              <a
                ...
                aria-label="Facebook"
                style={{ border: "1px solid rgba(198,165,107,0.3)", color: "#EADDCD" }}
                className="group flex h-9 w-9 items-center justify-center rounded-full transition-all duration-300 hover:border-[#B87B68] hover:bg-[#B87B68] hover:text-[#2B2B2B]"
              >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <a
                ...
                className="group inline-flex w-fit items-start gap-3 text-sm leading-6 text-[#EADDCD] transition-colors duration-200 hover:text-[#B87B68] dark:text-[#F0EDE8]"
              >
            ...
            <nav className="flex flex-col gap-2">
              {[
                ...
                <Link
                  key={href}
                  href={href}
                  className="group flex items-center gap-2 text-sm text-[#EADDCD] transition-colors duration-200 hover:text-[#B87B68] dark:text-[#F0EDE8]"
                >
                  <span
                    style={{ background: "#B87B68" }}
        ...
        {/* ── Divider ── */}
        <div
          style={{ background: "linear-gradient(90deg, transparent, #B87B6844, transparent)" }}
          className="my-8 h-px w-full dark:bg-[#3D3530]"
        />

        {/* ── Bottom bar ── */}
        <div className="flex flex-col items-center justify-between gap-3 sm:flex-row">
          <p className="text-xs text-[#EADDCD] dark:text-[#8A7D75]">
